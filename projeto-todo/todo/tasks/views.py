...
def taskList(request):
    ...
    paginator = Paginator(tasks_list, 3) #para caso tenha mais de 3 páginas vão ser separados para a outra página

    page = request.GET.get('page') 
    tasks = paginator.get_page(page) #vai mostrar 3 ná página que estã, página 1, 2...
